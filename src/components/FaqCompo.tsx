                ...
                <div className="container">
                    <div className="row gy-5">
                        <div className="col-lg-6">
                            <div className="faq-accordion accordion accordion-flush" id="accordionFlushExample" data-aos="fade-right">
                                <h5>Frequently Asked Questions</h5>
                                <div className="faq-item accordion-item">
                                    <h2 className="accordion-header">
                                        <button className="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                            <span className="faq-heading">
                                                Do you offer international shipping?
                                            </span>
                                            <span className="plus">
                                                <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current text-qpurple">
                                ...
                                <div className="faq-item accordion-item">
                                    <h2 className="accordion-header">
                                        <button className="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetwo" aria-expanded="false" aria-controls="flush-collapsetwo">
                                            <span className="faq-heading">
                                ...
                                <div className="faq-item accordion-item">
                                    <h2 className="accordion-header">
                                        <button className="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsethree" aria-expanded="false" aria-controls="flush-collapsethree">
                                            <span className="faq-heading">
                                ...
                                <div className="faq-item accordion-item">
                                    <h2 className="accordion-header">
                                        <button className="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefour" aria-expanded="false" aria-controls="flush-collapsefour">
                                            <span className="faq-heading">
                                ...
                                <div className="faq-item accordion-item">
                                    <h2 className="accordion-header">
                                        <button className="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-collapsefive">
                                            <span className="faq-heading">
                            ...
                            <div className="question-section login-section " data-aos="fade-left">
                                <div className="review-form">
                                    ...
                                    <div className="review-textarea">
                                        ...
                                        <textarea className="form-control" placeholder="Write Massage..........." id="floatingTextarea" rows={3} defaultValue={""} />
                                    </div>
                                    <div className="login-btn">
                                        <a href="#" className="shop-btn">Send Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
