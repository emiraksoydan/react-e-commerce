            ...
            <section className="product product-info">
                <div className="container">
                    <div className="blog-bradcrum">
                        ...
                        <span><Link to={"/productsidebar"}>Shop</Link></span>
                        <span className="devider">/</span>
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <div className="product-info-img" data-aos="fade-right">
                                    <div className="swiper product-top">
                                        <div className="product-discount-content">
                                            <h4>-50%</h4>
                                        </div>
                                    ...
                                    <div className="swiper product-bottom">
                                        <div className="swiper-wrapper">
                                            <div className="swiper-slide slider-bottom-img">
                            ...
                            <div className="col-md-6">
                                <div className="product-info-content" data-aos="fade-left">
                                    <span className="wrapper-subtitle">BOY'S FASHION</span>
                                    ...
                                    <div className="price">
                                        <span className="price-cut">$9.99</span>
                                        <span className="new-price">$6.99</span>
                                    </div>
                                    <p className="content-paragraph">It is a long established fact that a reader will be distracted
                                        by <span className="inner-text">the readable there content of a page.</span></p>
                                    <hr />
                                    <div className="product-availability">
                                        <span>Availabillity : </span>
                                        <span className="inner-text">132 Products Available</span>
                                    </div>
                                    <div className="product-size">
                                        <p className="size-title">Size</p>
                                        <div className="size-section">
                                            <span className="size-text">Select your size</span>
                                            <div className="toggle-btn">
                                                <span className="toggle-btn2" />
                                        ...
                                        <ul className="size-option">
                                            <li className="option">
                                                ...
                                                <span className="option-measure">3”W x 3”D x 5”H</span>
                                            </li>
                                            <li className="option">
                                                <span className="option-text">Medium</span>
                                                <span className="option-measure">3”W x 3”D x 6”H</span>
                                            </li>
                                            <li className="option">
                                                <span className="option-text">Large</span>
                                                <span className="option-measure">6”W x 3”D x 7”H</span>
                                            </li>
                                            <li className="option">
                                                <span className="option-text">Extra Large</span>
                                                <span className="option-measure">8”W x 4”D x 8”H</span>
                                            </li>
                                            <li className="option">
                                                <span className="option-text">2XL</span>
                                                <span className="option-measure">10”W x 5”D x 9”H</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="product-details">
                                        <p className="category">Category : <span className="inner-text">Kitchen</span></p>
                                        <p className="tags">Tags : <span className="inner-text">Beer, Foamer</span></p>
                                        <p className="sku">SKU : <span className="inner-text">KE-91039</span></p>
                                    </div>
                                    <hr />
                                    <div className="product-report">
                                        <a href="#" className="report" onClick={() => modalAction('.action')}>
                                            <span>
                                        ...
                                        <div className="modal-wrapper action">
                                            <div onClick={() => modalAction('.action')} className="anywhere-away" />
                                            {/* change this */}
                                            <div className="login-section account-section modal-main">
                                                <div className="review-form">
                                                    ...
                                                    <div className="review-form-name address-form">
                                                        <label htmlFor="reporttitle" className="form-label">Enter Report Ttile*</label>
                                                        <input type="text" id="reporttitle" className="form-control" placeholder="Reports Headline here" />
                                                    </div>
                                                    <div className="review-form-name address-form">
                                                        <label htmlFor="reportnote" className="form-label">Enter Report Note*</label>
                                                        <textarea name="ticketmassage" id="reportnote" cols={40} rows={3} className="form-control" placeholder="Type Here" defaultValue={""} />
                                                    </div>
                                                    <div className="login-btn text-center">
                                                        <a href="#" onClick={() => modalAction('.action')} className="shop-btn">Submit
                                                            Report</a>
                                                    </div>
                                                </div>
                                            </div>
