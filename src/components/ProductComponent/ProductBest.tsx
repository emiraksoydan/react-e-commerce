...
function ProductBest() {
    return (
        <div>
            <section className="product best-product">
                <div className="container">
                    <div className="section-title">
                        <h5>Flash Sale</h5>
                        <Link to={"/flashsale"} className="view">View All</Link>
                    </div>
                                ...
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Half Sleeve Dress
                                            </Link>
                                            <div className="price">
                                                <span className="price-cut">$12.99</span>
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Feminine Wrap coat
                                            </Link>
                                            <div className="price">
                                ...
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            ...
                                            <div className="price">
                                                <span className="price-cut">$10.99</span>
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Rainbow Party Dress
                                            </Link>
                                            <div className="price">
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Red Sequin Hat
                                            </Link>
                                            <div className="price">
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Gradient Party Shirt
                                            </Link>
                                            <div className="price">
                                                <span className="price-cut">$19.99</span>
                                                <span className="new-price">$10.99</span>
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">Blue Suit
                                            </Link>
                                            <div className="price">
                                                <span className="price-cut">$10.99</span>
                            ...
                            <div className="col-xl-2 col-md-4">
                                <div className="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <Link to={"/productinfo"} className="product-details">White Hat
                                            </Link>
                                            <div className="price">
                                                <span className="price-cut">$29.99</span>
