...
function FlashSaleProductCompo() {
    return (
        <div>
            <section className="product product-sidebar flash footer-padding">
                <div className="container">
                    <div className="product-sidebar-section">
                        <div className="row g-5">
                            <div className="col-lg-12">
                                <div className="flash-sale" data-aos="fade-up">
                                    <div className="countdown-section">
                                        <div className="countdown-items">
                                            <span id="day" className="number" style={{ color: 'red' }}>0</span>
                                            <span className="text">Days</span>
                                        </div>
                                        <div className="countdown-items">
                                            <span id="hour" className="number" style={{ color: 'skyblue' }}>0</span>
                                            <span className="text">Hours</span>
                                        </div>
                                        <div className="countdown-items">
                                            <span id="minute" className="number" style={{ color: 'green' }}>0</span>
                                            <span className="text">Minutes</span>
                                        </div>
                                        <div className="countdown-items">
                                            <span id="second" className="number" style={{ color: 'red' }}>0</span>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="product-wrapper" data-aos="fade-up" data-aos-duration={200}>
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <a href="product-info.html" className="product-details">Flower Design Dress
                                            </a>
                                            <div className="price">
                            ...
                            <div className=" col-lg-3 col-sm-6">
                                <div className="product-wrapper" data-aos="fade-up" data-aos-duration={300}>
                                    <div className="product-img">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            ...
                                            <div className="price">
                                                <span className="price-cut">$49.99</span>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="product-wrapper" data-aos="fade-up" data-aos-duration={400}>
                                    <div className="product-img">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="product-wrapper" data-aos="fade-up" data-aos-duration={500}>
                                    <div className="product-img">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="product-wrapper" data-aos="fade-up" data-aos-duration={300}>
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-description">
                                            <a href="product-info.html" className="product-details">Red baby Dress
                                            </a>
                                            <div className="price">
...
export default FlashSaleProductCompo