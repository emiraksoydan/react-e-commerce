                            ...
                            <div className="swiper-wrapper">
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">enean ullamcorper at magna et in to
                                        <span className="testimonial-inner-text">
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            ...
                                            <p className="testimonial-title">Ceo of <span className="title-inner">DesginCraft</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">Almost every imaginable design is possible and customizations
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            ...
                                            <p className="testimonial-title">Cfo of <span className="title-inner">DesginX</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">As a digital marketing agency our team works day in and day
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            ...
                                            <p className="testimonial-title">HR of <span className="title-inner">Desgin360</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">It is a long established fact that a reader will be
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            <h5 className="testimonial-name">Abdullah Al Mamun</h5>
                                            <p className="testimonial-title">Designer of <span className="title-inner">DesginCode</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">Build the perfect online store using our high-converting
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            <h5 className="testimonial-name">Mohammad Rashed Khan</h5>
                                            <p className="testimonial-title">Ceo of <span className="title-inner">DesginLab</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide testimonial-wrapper">
                                    ...
                                    <p className="testimonial-details">The lightweight and fully responsive eCommerce website
                                    ...
                                    <div className="testimonial-info">
                                        ...
                                        <div className="testimonial-info-details">
                                            <h5 className="testimonial-name">Shuvo Raihan</h5>
                                            <p className="testimonial-title">Developer of <span className="title-inner">DesginUX</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
