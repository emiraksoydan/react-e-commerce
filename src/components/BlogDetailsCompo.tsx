...
function BlogDetailsCompo() {
    return (
        <div>
            <section className="blog-details product footer-padding">
                                    ...
                                    <div className="wrapper-info">
                                        ...
                                        <div className="blog-details">
                                            <p>
                                                ...
                                                iudicabit.
                                                <span className="paragraph-inner-text">
                                ...
                                <div className="blogs-form-section">
                                    ...
                                    <div className="review-form">
                                        ...
                                        <div className="review-textarea">
                                            ...
                                            <textarea className="form-control" placeholder="Write something..........." id="floatingTextarea" rows={8} defaultValue={""} />
                                        </div>
                                        <div className="review-btn">
                                            <a href="#" className="shop-btn">Submit Review</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row g-5">
                                        <div className="col-lg-12">
                                            <div className="blog-post search">
                                                <h5 className="post-details">Search</h5>
                                                <hr />
                                                <div className="search-btn">
                                                    <input type="text" placeholder="search" />
                                                    <span>
                                                        <svg width={25} height={25} viewBox="0 0 25 25" fill="#AE1C9A" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="blog-post Latest-post">
                                                <h5 className="post-details">Latest Post</h5>
                                                <hr />
                                                <div className="blogs-wrapper product-wrapper">
                                                    <div className="wrapper-img">
                                                        <img src="./assets/images/homepage-one/about/blog-img-1.webp" alt="img" />
                                                    </div>
                                                    <div className="wrapper-info">
                                                        <h5 className="about-details wrapper-details">Business-to-consumer that
                                                            involves selling fight products
                                                        </h5>
                                                        <div className="wrapper-data">
                                                            <div className="admin wrapper-item">
                                                                <span className="icon">
                                                                    <svg width={14} height={13} viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                                                ...
                                                <div className="blogs-wrapper product-wrapper">
                                                    ...
                                                    <div className="wrapper-info">
                                                        <h5 className="about-details wrapper-details">15 Best WordPress Newspaper Themes to Look Out for in 2022
                                                        </h5>
                                                        <div className="wrapper-data">
                                                            <div className="admin wrapper-item">
                                                                <span className="icon">
                                                ...
                                                <div className="blogs-wrapper product-wrapper">
                                                    ...
                                                    <div className="wrapper-info">
                                                        <h5 className="about-details wrapper-details">6 Best WordPress E-commerce Plugins for Online Stores in 2022
                                                        </h5>
                                                        <div className="wrapper-data">
                                                            <div className="admin wrapper-item">
                                                                <span className="icon">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="blog-post category-post">
                                                <h5 className="post-details">Categories</h5>
                                                <hr />
                                        ...
                                        <div className="col-lg-12">
                                            <div className="blog-post newsletter">
                                                <h5 className="post-details">Our Newsletter</h5>
                                                <hr />
                                                <p className="blog-paragraph">Follow our newsletter to stay updated about us.</p>
                                                <div className="form">
                                                    <input type="text" placeholder="Enter Your Email Address" />
                                                    <a href="#" className="shop-btn">Subscribe</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
